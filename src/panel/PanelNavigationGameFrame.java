...
public class PanelNavigationGameFrame extends JPanel implements Runnable{
	...
	labelMushroomScore, labelSwampScore, labelTotalScore;
	private JButton btVolume;
	public int heightNavigation = 0;
	private int appleScore = 0, energyScore = 0, mushroomScore = 0, swampScore = 0, highScore = 0, totalScore = 0;
	...
	public PanelNavigationGameFrame(int width, int height, ScreenGame screenGame) {
		...
		labelTotalScore = new JLabel("" + this.totalScore);
//		labelTotalScore = new JLabel("" + this.totalScore);
	...
	public void paintFrame(Graphics g) {
		...
		labelTotalScore.setText("" + totalScore);
		labelTotalScore.setFont(labelTotalScore.getFont().deriveFont(15.0f));
		labelTotalScore.setForeground(Color.WHITE);
		labelTotalScore.setIcon( resizeImage("D:\\git\\SnakeGame_ver2\\src\\data\\cup.png", 20, 20));
...
//		btVolume.setBackground(new Color(0, 139, 69));
		...
		layoutN.putConstraint(SpringLayout.WEST, labelTotalScore, 300, SpringLayout.WEST, this);
		layoutN.putConstraint(SpringLayout.NORTH, labelTotalScore, 10, SpringLayout.NORTH, this);
