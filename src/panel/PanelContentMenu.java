...
public class PanelContentMenu extends JPanel{
	...
	private ImageIcon iconReplaceExit,iconPlay, iconLevel, iconScore, iconPlayer, iconHelp, iconExit;
...
//		iconPlay = new ImageIcon("D:\\git\\SnakeGame_ver2\\src\\data\\Play.png");
...
//		btPlay.setPreferredSize(new Dimension(87, 35));
		...
		iconLevel = new ImageIcon("D:\\git\\SnakeGame_ver2\\src\\data\\Play.png");
		...
		iconScore = new ImageIcon("D:\\git\\SnakeGame_ver2\\src\\data\\Score.png");
		...
		iconExit = new ImageIcon("D:\\git\\SnakeGame_ver2\\src\\data\\Exit.png");
		...
		btExit.setBackground(Color.WHITE); // đặt màu nền trắng cho nút
